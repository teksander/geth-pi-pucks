...
contract ForagingPtManagement{
    ...
    uint constant inflation_reward = 26666666666666666666; //inflation reward R, R/#winner
    int256 constant max_unverified_cluster =  3;
    uint256 constant K =  3;
    
    uint256 public supply = 0;
    mapping (address => uint) public balances;
    mapping (address => uint) public tokens; // Tracker of onchain deposit values
    ...
    function stake() private returns (uint256 amount) {  
        amount = tokens[msg.sender]/K;
        require(tokens[msg.sender]-staked[msg.sender] > amount, "Not enough tokens");
